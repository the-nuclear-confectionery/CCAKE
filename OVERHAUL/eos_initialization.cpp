...
//    for (double muQ0 = 3000.0; muQ0 <= 3000.01; muQ0 += 500.0)
    for (double T0 =  150.0000001; T0 <= 150.01; T0 += 500.0)
    for (double muB0 = 150.0000001; muB0 <= 150.01; muB0 += 500.0)
    for (double muS0 = 300.0000001; muS0 <= 300.01; muS0 += 500.0)
    for (double muQ0 = 450.0000001; muQ0 <= 450.01; muQ0 += 500.0)
