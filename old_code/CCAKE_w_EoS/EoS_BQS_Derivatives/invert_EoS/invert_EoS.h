...
double get_b_min_max( vector<double> & v, const size_t iT,
						const size_t nTpts, const size_t nmuBpts,
						const size_t nmuQpts, const size_t nmuSpts )
{
	vector<double> maxima;
...
double get_q_min_max( vector<double> & v, const size_t iT,
						const size_t nTpts, const size_t nmuBpts,
						const size_t nmuQpts, const size_t nmuSpts )
{
	vector<double> maxima;
...
double get_s_min_max( vector<double> & v, const size_t iT,
						const size_t nTpts, const size_t nmuBpts,
						const size_t nmuQpts, const size_t nmuSpts )
{
	vector<double> maxima;
